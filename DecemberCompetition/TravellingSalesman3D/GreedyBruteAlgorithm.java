...
public class GreedyBruteAlgorithm
{
    public static ArrayList<DecemberCompetition.Point> solveProblem (ArrayList<DecemberCompetition.Point> points) {
        ...
        ArrayList<DecemberCompetition.Point> bestSubsetPath = bruteForce(subset);
    ...
    public static ArrayList<DecemberCompetition.Point> bruteForce (ArrayList<DecemberCompetition.Point> points) {
        ...
        for (int i = 0; i < pCombs.size(); i++) {
            double len = PathMeasure.evalPathLen(pCombs.get(i));
            if (len < bestLen) {
                len = bestLen;
